...
from data import RerankerTrainDataset, RerankerTrainCollator, HFRerankerTrainDataset
...
def main():
    ...
    train_dataset = HFRerankerTrainDataset(tokenizer=tokenizer, data_args=data_args,
